        ...
        <div class="layadmin-user-login-main">
            ...
            <div class="layadmin-user-login-box layadmin-user-login-body layui-form" lay-filter="user-login-form">
                <div class="layui-form-item">
                    ...
                    <input autocomplete="off" type="text" name="userName" id="LAY-user-login-username" lay-verify="required"
                           placeholder="姓名" class="layui-input">
                </div>
                <div class="layui-form-item">
                    <label class="layadmin-user-login-icon layui-icon layui-icon-password"
                           for="LAY-user-login-password"></label>
                    <input autocomplete="off" type="password" name="userPwd" id="LAY-user-login-password"
                           lay-verify="required"
...
<script>
    layui.use(['form', 'element', 'layer'], function () {
        ...
        form.on('submit(user-login-submit)', function (data) {
            ...
            alert(userInfo.userName+","+userInfo.userPwd);
